            ...
            <Box sx={{ mt: 9, padding: 5 }}>
                ...
                sx={{
                  ...
                  background:
                    ...
                    "linear-gradient(135deg, blue 30%, #21CBF3 70%)",
                  color: "#fff",
                  "&:hover": {
                    background:
                    //   "linear-gradient(45deg, #1976D2 30%, #1E88E5 90%)",
                      "linear-gradient(135deg, #000099 30%, #10bae2 70%)",
                  },
                }}
              >
                Edit Profile
              </Button>
                    ...
                    <Grid item xs={6}>
                      ...
                      sx={{
                        ...
                        mb: 2,
                        background:
                          "linear-gradient(45deg, #B21F5F 30%, #6A0DAD 90%)", // swapped gradient
                        color: "#fff",
                        "&:hover": {
                          background:
                            "linear-gradient(45deg, #9A1B4D 30%, #5E0F77 90%)", // swapped darker hover
                        },
                      }}
                    >
                      Update Profile
