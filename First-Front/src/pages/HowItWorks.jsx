...
import image2 from "../assets/bill_illustration.jpeg";
...
export default function HowItWorks() {
  return (
    <div className="font-sans text-gray-800">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between bg-purple-600 px-6 py-16 text-white">
      ...
      <section className="bg-gray-100 py-16 px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white p-6 rounded shadow-lg hover:shadow-xl transition">
            ...
            />
            <h4 className="font-bold text-lg mb-2">Step 1 : Upload Your Daily Bills</h4>
            <p className="text-gray-600 text-sm">
              Share receipts from groceries, fuel, dining or utility payments directly
              through First-Buy and start collecting rewards instantly.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg hover:shadow-xl transition">
            <img
              ...
              className="w-full h-40 object-cover rounded mb-4"
            />
            <h4 className="font-bold text-lg mb-2">Step 2 : Get Rewarded Instantly</h4>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white p-6 rounded shadow-lg hover:shadow-xl transition">
            <img
              ...
              className="w-full h-40 object-cover rounded mb-4"
            />
            <h4 className="font-bold text-lg mb-2">Step 3 : Unlock Premium Offers</h4>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white p-6 rounded shadow-lg hover:shadow-xl transition">
            <img
              ...
              className="w-full h-40 object-cover rounded mb-4"
            />
            <h4 className="font-bold text-lg mb-2">Step 4 : Big Saving on Your Home</h4>
            <p className="text-gray-600 text-sm">
              Redeem your collected points as saving on your property purchase with first-buy.
            </p>
          </div>
